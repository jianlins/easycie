...
import static edu.utah.bmi.nlp.easycie.core.CommonFunc.addOption;
import static edu.utah.bmi.nlp.easycie.core.CommonFunc.getCmdValue;
...
public class Compare {
    ...
    protected NLPDBConsoleLogger logger;
    ...
    protected void init(CommandLine cmd) {
        ...
        logger = new NLPDBConsoleLogger(writeConfigFileName, "LOG", "RUN_ID", annotator + "_vs_" + referenceAnnotator);
        logger.logStartTime();
    ...
    public void logDiff(EDAO dao, NLPDBConsoleLogger logger, boolean strictCompare, EvalCounter evalCounter, String annotator, String annotator2, String diffTable) {
...
//        System.out.println("\n" + compareName + " comparision finished. Saving the difference to SQLite...");
    ...
    protected void logAnnoDifferenceWSentence(EDAO dao, NLPDBConsoleLogger logger, String annotator, String note, ArrayList<RecordRow> fpannos, String diffTable) {
