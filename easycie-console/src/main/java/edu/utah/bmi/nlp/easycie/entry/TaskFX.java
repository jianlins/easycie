...
public class TaskFX {
    protected LinkedHashMap<String, SettingAb> paras;
    ...
    public ArrayList<Map.Entry<String, SettingAb>> getSettings() {
    ...
    public ArrayList<Map.Entry<String, SettingAb>> getExecutes() {
