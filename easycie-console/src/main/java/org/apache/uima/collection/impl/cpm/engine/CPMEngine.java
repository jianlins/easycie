...
import org.apache.uima.collection.impl.cpm.engine.*;
...
public class CPMEngine extends Thread {
     ...
     *
     * @param aInputQueueSize the size of the batch.
     */
     ...
     *
     * @param aOutputQueueSize the size of the batch.
     */
     ...
     *
     * @param aPoolSize the size of the Cas pool.
     */
     ...
     *
     * @param aConcurrentThreadSize the size of the batch.
     */
    ...
    */
    ...
    public void addCasProcessor(CasProcessor aCasProcessor, int aIndex)
        ...
        if (indexPos == -1) {
            ...
            initial_cp_list.add(aIndex, newList);
        } else {
     ...
     *                          CasProcessor name in processing pipeline
     */
    public void removeCasProcessor(String aCasProcessorName) {
        int aCasProcessorIndex = getPositionInListIfExists(aCasProcessorName, initial_cp_list);
        removeCasProcessor(aCasProcessorIndex);
    }
     ...
     *
     * @param aCasProcessor -
     *                      CasProcessor in processing pipeline
     */
    public void removeCasProcessor(CasProcessor aCasProcessor) {
        String aCasProcessorName = aCasProcessor.getProcessingResourceMetaData().getName();
        removeCasProcessor(aCasProcessorName);
    }
    ...
    private BoundedWorkQueue createOutputQueue(int aQueueSize) throws Exception {
        ...
        if (cpeFactory.getCPEConfig().getOutputQueue() != null
            ...
            if (outputQueueClass != null) {
                Class[] args = new Class[]{int.class, String.class, org.apache.uima.collection.impl.cpm.engine.CPMEngine.class};
...
//        }
     ...
     * sizing parameters.
     *
     * @param aPerformanceTuningSettings the new settings
