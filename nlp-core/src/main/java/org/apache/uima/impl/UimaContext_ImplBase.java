...
public abstract class UimaContext_ImplBase implements UimaContextAdmin {
     ...
     * Not expected to be checkModifiedAEs after set.
     */
     ...
     * (non-Javadoc)
     *
     * @see UimaContextAdmin#getExternalOverrides()
     */
     ...
     * (non-Javadoc)
     *
     * @see UimaContextAdmin#setExternalOverrides(Settings)
     */
     ...
     *
     * @see org.apache.uima.UimaContext#mapToSofaID(String)
     */
     ...
     * (non-Javadoc)
     *
     * @see org.apache.uima.UimaContext#mapSofaIDToComponentSofaName(String)
     */
