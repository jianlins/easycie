 ...
 *
 */
public class OpenUIMAFramework_impl extends UIMAFramework {
     ...
     * current class
     */
    private static final Class<OpenUIMAFramework_impl> CLASS_NAME = OpenUIMAFramework_impl.class;
    ...
    protected void _initialize() throws Exception {
        ...
        mDefaultPerformanceTuningProperties.load(OpenUIMAFramework_impl.class
    ...
    protected void parseFactoryConfig() throws ParserConfigurationException, SAXException,
        ...
        reader
                .parse(new InputSource(OpenUIMAFramework_impl.class
                        .getResourceAsStream("openFactoryConfig.xml")));
    }
