 ...
 * generated */
public class Bunch_Base_Type extends EntityBASE_Type {
  /** generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Bunch_Base_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Bunch_Base_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Bunch_Base(addr, Bunch_Base_Type.this);
  			   Bunch_Base_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Bunch_Base(addr, Bunch_Base_Type.this);
  	  }
    };
  /** generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Bunch_Base.typeIndexID;
  /** generated 
     modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.utah.bmi.nlp.type.system.Bunch_Base");
  ...
  public String getTopic(int addr) {
      ...
      jcas.throwFeatMissing("Topic", "edu.utah.bmi.nlp.type.system.Bunch_Base");
  ...
  public String getFeatures(int addr) {
      ...
      jcas.throwFeatMissing("Features", "edu.utah.bmi.nlp.type.system.Bunch_Base");
  ...
  public String getNote(int addr) {
      ...
      jcas.throwFeatMissing("Note", "edu.utah.bmi.nlp.type.system.Bunch_Base");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Bunch_Base_Type(JCas jcas, Type casType) {
    super(jcas, casType);
