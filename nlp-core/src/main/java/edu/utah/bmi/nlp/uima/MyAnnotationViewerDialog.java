 ...
 */
public class MyAnnotationViewerDialog extends JDialog implements ActionListener {
     ...
     * @param aTypesToDisplay          array of types that should be highlighted in the viewer. This
     *                                 can be set to the output types of the Analysis Engine. A value
     *                                 of null means to display all types.
     * @param interactiveTempFN        interactiveTempFN
     * @param javaViewerRBisSelected   javaViewerRBisSelected
     * @param javaViewerUCRBisSelected javaViewerUCRBisSelected
     * @param xmlRBisSelected          xmlRBisSelected
     * @param cas                      cas
     */
    public MyAnnotationViewerDialog(JFrame aParentFrame, String aDialogTitle, PrefsMediator med, File aStyleMapFile,
                                    String aPerformanceStats, TypeSystem aTypeSystem, final String[] aTypesToDisplay, String interactiveTempFN,
                                    boolean javaViewerRBisSelected, boolean javaViewerUCRBisSelected, boolean xmlRBisSelected, CAS cas) {
        ...
        launchThatViewer(med.getOutputDir(), interactiveTempFN, aTypeSystem, aTypesToDisplay, javaViewerRBisSelected,
                javaViewerUCRBisSelected, xmlRBisSelected, aStyleMapFile, tempDir);
    }


    public MyAnnotationViewerDialog(JFrame aParentFrame, String aDialogTitle, PrefsMediator med, File aStyleMapFile,
                                    String aPerformanceStats, TypeSystem aTypeSystem, final String[] aTypesToDisplay, boolean generatedStyleMap,
                                    CAS cas) {
...
//		southernPanel.add(controlsPanel);
    ...
    public void displayError(String aErrorString) {
        ...
        JOptionPane.showMessageDialog(MyAnnotationViewerDialog.this, buf.toString(), "Error",
