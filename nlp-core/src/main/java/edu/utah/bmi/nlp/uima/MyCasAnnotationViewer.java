 ...
 * </ul>
 */
public class MyCasAnnotationViewer extends JPanel {
...
//    group.add(this.entityModeButton);
     ...
     *
     * @param aTypeNames names of types that are occur frequently. Ideally these should be ordered by
     ...
     *
     * @param aDisplayedTypeNames names of types that are to be highlighted. Null indicates that all types in the CAS
     ...
     *
     * @param aFeatureNames array of (short) feature names to be hidden
     */
     ...
     *
     * @param aConsistent true (the default) causes colors to be consistent across documents, false allows them
     *                    to vary
     */
     ...
     *
     * @param aRightToLeft true to put the viewer in right-to-left mode, false for left-to-right (the default).
     */
     ...
     *
     * @param aHideUnselected aHideUnselected
     */
     ...
     *
     * @param aCAS the CSA to be viewed
     */
     ...
     *
     * @param aWords array of words to highlight in boldface.
     */
     ...
     *
     * @param aSpans spans to appear in boldface (begin1, end1, begin2, end2, ...)
     */
     ...
     *
     * @param aQuery         an XML fragments query
     * @param aTypeNamespace namespace to prepend to the element names in the query in order to form
     ...
     *
     * @param aPosition the currently selected offset into the document. All annotations overlapping this
...
//      String rangeTypeName = rangeType.getName();
     ...
     *
     * @param names Type names, which may include wildcards (e.g, uima.tt.*)
    ...
    /**
     * @param name    A litteral string
     * @param pattern A string that includes one or more *'s as wildcards
